...
if (isset($_POST['btnSubmit'])) {
    ...
    if ($objEP->hasil) {
        echo "<script> window.location = 'Main.php?Pages=employeeprojectlist'; </script>";
    }
}
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="Main.php?Pages=employeeprojectlist" class="btn btn-warning">Cancel</a>
            </td>
        </tr>
    </table>
</form>
