...
<a class="btn btn-primary" href="Main.php?Pages=employeeproject">Add</a>
    ...
    if (count($arrayResult) == 0) {
        ...
        foreach ($arrayResult as $dataEP) {
            ...
            echo '<td>
                    ...
                    href="Main.php?Pages=employeeproject&id='.$dataEP->id.'"> Edit </a> |
                    <a class="btn btn-danger"
                    href="Main.php?Pages=deleteemployeeproject&id='.$dataEP->id.'" onclick="return
