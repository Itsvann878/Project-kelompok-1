...
<form action="" method="post">
    <table class="table">
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <input type="text" class="form-control" name="fname" value="<?php echo $objEmployee->fname; ?>">
            </td>
        </tr>
        <tr>
            <td>Address</td>
            <td>:</td>
            <td>
                <textarea class="form-control" name="address" rows="3" cols="19"><?php echo $objEmployee->address; ?></textarea>
            </td>
        </tr>
        <tr>
            <td colspan="2"></td>
